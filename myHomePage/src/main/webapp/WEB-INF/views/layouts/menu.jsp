...
<body>
	<div class="d-flex flex-column flex-shrink-0 p-3 sidebar text-white col-md-2 col-12 border-end border-secondary">
	    <a href="home.do" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
	    ...
	    <ul class="nav nav-pills flex-column mb-auto">
	      <li class="nav-item">
	        <a href="home.do" class="nav-link active" aria-current="page">
