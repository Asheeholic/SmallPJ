				...
				<form id="frm" name="frm" action="memberInsert.do" method="post"
					...
					<div>
						<table border="1">
							<tr>
								<th width="150">아이디</th>
								<td width="350"><input type="text" id="id" name="id"
									placeholder="아이디 입력" required="required"> <input
									type="button" value="중복확인" onclick="idCheck()"></td>
							</tr>
							<tr>
								<th width="150">비밀번호</th>
								<td width="350"><input type="password" id="password"
									name="password" placeholder="비밀번호 입력" required="required"
									onchange="check_pw()"></td>
							</tr>
							<tr>
								<th width="150">비밀번호 확인</th>
								<td width="350"><input type="password" id="passcheck"
									name="passcheck" placeholder="비밀번호 확인" onchange="check_pw()"
									required="required"><span id="check"></span></td>
							</tr>
							<tr>
								<th width="150">이 름</th>
								<td width="350"><input type="text" id="name" name="name"
									required="required"></td>
							</tr>
							<tr>
								<th width="150">나 이</th>
								<td width="350"><input type="text" id="age" name="age"
									required="required"></td>
							</tr>
							<tr>
								<th width="150">학과명</th>
								<td width="350"><select name="department" id="department"
									required="required">
							...
							<tr>
								<th width="150">직책</th>
								<td width="350"><select name="author" id="author"
